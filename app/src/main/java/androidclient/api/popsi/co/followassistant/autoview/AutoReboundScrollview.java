...
public class AutoReboundScrollview extends ScrollView {
    // y方向上当前触摸点的前一次记录位置
    ...
    public AutoReboundScrollview(Context context) {
        super(context);
    }

    public AutoReboundScrollview(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public AutoReboundScrollview(Context context, AttributeSet attrs, int defStyle) {
